...
pub struct PyPolynomialArray {
	pub(crate) inner: seal::PolynomialArray,
}
...
impl PyPolynomialArray {
	...
	pub fn new() -> PyResult<Self> {
		let poly_array = seal::PolynomialArray::new().map_err(|e| {
	...
	pub fn from_ciphertext(
		...
		let poly_array =
			seal::PolynomialArray::new_from_ciphertext(&context.inner, &ciphertext.inner).map_err(
				|e| {
					PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!(
	...
	pub fn from_public_key(
		...
		let poly_array =
			seal::PolynomialArray::new_from_public_key(&context.inner, &public_key.inner).map_err(
				|e| {
					PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!(
	...
	pub fn from_secret_key(
		...
		let poly_array =
			seal::PolynomialArray::new_from_secret_key(&context.inner, &secret_key.inner).map_err(
				|e| {
					PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!(
