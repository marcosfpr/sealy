...
/// to store the encryption parameters, the seal::Context class is a heavy-weight class that
...
pub struct PyContext {
	pub(crate) inner: seal::Context,
}

#[pymethods]
impl PyContext {
	/// Creates an instance of seal::Context and performs several pre-computations
	...
	pub fn new(
		...
		let context = seal::Context::new(&params.inner, expand_mod_chain, security_level.inner)
			.map_err(|e| {
